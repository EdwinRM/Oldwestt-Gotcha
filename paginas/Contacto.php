...
<html lang="en">
    ...
    <body>  
               ...
               <section id="CUERPO">
                   <?php $campo='telefono';  $dato=$Funciones->get_info_datos_empresa_by_campo($campo);?>
                   <p style="color: white;" class="texto-conacto">Estamos ubicados en: <br>Pilancon, 76500 Cadereyta de Montes, Qro, México <br>✆ <?php echo $dato;?> </p>                 
